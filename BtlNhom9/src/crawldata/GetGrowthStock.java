...
public class GetGrowthStock {
	...
	public static List <GrowthStock> crawlData() {
		...
		List <GrowthStock> gslist = new ArrayList <GrowthStock>();
		...
		try {
			for (int i=1;i<=8;i++) {
				...
				growthstock.setPrice(Double.valueOf(driver.findElement("/html[1]/body[1]/form[1]/div[3]/div[1]/div[2]/div[2]/div[2]/div[4]/div[5]/div[1]/div[1]/table[1]/tbody[1]/tr["+ i +"]/td[3]").substring(0, 4)));
				growthstock.setPercentChangeMax(Double.valueOf(driver.findElement("/html[1]/body[1]/form[1]/div[3]/div[1]/div[2]/div[2]/div[2]/div[4]/div[5]/div[1]/div[1]/table[1]/tbody[1]/tr["+ i +"]/td[5]/em[1]").replaceAll("%", "" )));
				growthstock.setTotalAsset(Double.valueOf(driver.findElement("/html[1]/body[1]/form[1]/div[3]/div[1]/div[2]/div[2]/div[2]/div[4]/div[5]/div[1]/div[1]/table[1]/tbody[1]/tr["+ i +"]/td[2]").replaceAll(" Tỷ", "").replace(",", "")));
				growthstock.setPercentChange(Double.valueOf(driver.findElement("/html[1]/body[1]/form[1]/div[3]/div[1]/div[2]/div[2]/div[2]/div[4]/div[5]/div[1]/div[1]/table[1]/tbody[1]/tr["+ i +"]/td[3]/span[1]").replaceAll(" %", "")));
				...
				else growthstock.setAvgTrade(Double.valueOf(avg));
