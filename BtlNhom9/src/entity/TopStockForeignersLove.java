...
public class TopStockForeignersLove extends Stock{
    //https://s.cafef.vn/TraCuuLichSu2/3/HOSE/today.chn#data
	...
	public static List<TopStockForeignersLove> topUpper(List<TopStockForeignersLove> lst) {
		List<TopStockForeignersLove> top = new ArrayList<TopStockForeignersLove>();
		for (TopStockForeignersLove i: lst) {
			if (i.getTotalValueNet() >= 1000000) top.add(i);
		}
		return top;
	}
