...
public class SentencesIndex {
    ...
    private static final String[] TANG = new String[] {

            "Đóng cửa phiên giao dịch, [name] tăng [change] điểm tức [percentChange]%, đạt [point] điểm" ,
            "Chốt phiên hôm nay, [name] đạt [point] điểm, tăng [change] điểm ứng với [percentChange]%. ",

    };

    public static final String[] GIAM = new String[] {
