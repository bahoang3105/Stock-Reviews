...
public class SentencesTopStockInDay {
    ...
    String[] stringUp = new String[5];
    String[] stringDown = new String[5];
    Random random = new Random();

    public String creatUpSentences(TopStockInDay ts) {
    ...
    public String creatDownSentences(TopStockInDay ts) {
